  ...
  return (
    <div className={`${isMobile ? 'min-h-screen' : 'h-screen'} flex items-center justify-center relative bg-gradient-to-br from-brand-blue via-brand-lightBlue to-brand-red`}>
      ...
      <section className="section-container relative z-10 pt-20">
        <div className={isMobile ? "max-w-4xl mx-auto px-3" : "max-w-4xl mx-auto"}>
          <motion.h1
          ...
          >
            ...
            <p className="text-gray-100 mb-4 text-justify">
              {language === 'en' ?
                'Together, we are an agile and creative agency focused on making each project leave its mark.' :
                'Juntos, somos una agencia ágil y creativa, enfocada en hacer que cada proyecto deje huella.'}
            </p>
            <p className="text-gray-100 font-justify">
              {language === 'en' ?
